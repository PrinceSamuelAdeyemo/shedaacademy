  ...
  return (
    <div className='flex justify-center pb-24'>
      <div className='flex flex-col gap-1 w-[97%]'>
        ...
        <div className='flex flex-col px-3 py-4 gap-5 border-[1px] rounded-lg mb-4'>
          ...
          <div className='flex flex-col gap-2 lg:flex-row lg:gap-6'>
            <div className='flex flex-col border-2 border-shedanormalpurple relative justify-between rounded-lg text-white p-2 lg:h-[7rem] lg:w-[15%]'>
              ...
              <p className='text-shedanormalpurple text-xl font-semibold'>Graduate Student</p>
            </div>
            ...
            <div className='flex flex-col border-2 border-shedared relative justify-between rounded-lg text-white p-2 lg:h-[7rem] lg:w-[15%]'>
              ...
              <p className='text-shedared text-xl font-semibold'>Expel Student</p>
            </div>
          </div>
        </div>
          ...
          <div className='flex flex-col gap-6'>
            ...
            <div className='flex gap-8'>
              <div className='flex gap-3'>
                <p className='text-shedagray'>Student ID:</p>
              ...
              <div className='flex gap-3'>
                <p className='text-shedagray'>Studentship:</p>
                <p className='text-black font-semibold'>Active</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='flex border-[1px] px-4 py-5 rounded-lg'>
          <AcademyStudentPaymentInfo />  
        </div>
