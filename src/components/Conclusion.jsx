...
const Conclusion = () => {
  return (
    ...
    {/* <div id='conclusion' className='flex justify-center items-center md:h-[45vh] md:w-[90vw]'> */}
      <div className='flex flex-col items-center justify-center relative rounded-xl py-8 font-semibold text-white text-center md:h-full w-[90%] gap-4 bg-shedared'>
